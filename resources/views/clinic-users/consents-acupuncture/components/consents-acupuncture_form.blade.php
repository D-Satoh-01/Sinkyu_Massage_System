{{-- resources/views/clinic-users-info/cui-consenting-doctor-history-acupuncture/components/consenting-form.blade.php --}}
...
<div class="consenting-form">
  ...
  <div class="mb-3">
    <label class="fw-semibold" for="consenting_start_date">同意開始日</label><br>
  ...
  <div class="mb-3">
    <label class="fw-semibold" for="consenting_end_date">同意終了日</label><br>
  ...
  <div class="mb-3">
    <label class="fw-semibold" for="benefit_period_start_date">給付期間開始日</label><br>
  ...
  <div class="mb-3">
    <label class="fw-semibold" for="benefit_period_end_date">給付期間終了日</label><br>
  ...
  <div class="mb-3">
    <label class="fw-semibold" for="first_care_date">初療日</label><br>
  ...
  <div class="mb-3">
    <label class="fw-semibold" for="reconsenting_expiry">再同意期限</label><br>
  ...
  <div class="mb-3">
    <label class="fw-semibold" for="onset_and_injury_date">発症・負傷日</label><br>
  ...
  <div class="mb-3">
    <label class="fw-semibold" for="notes">備考</label><br>
